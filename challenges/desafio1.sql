...
INSERT INTO SpotifyClone.plans (id, type, price)
VALUES
  (1, 'gratuito', 0.00),
  (2, 'familiar', 7.99),
...
INSERT INTO SpotifyClone.albums (id, name, artist_id, year_launch)
VALUES
...
INSERT INTO SpotifyClone.users (id, name, age, plan_id, signature_date)
VALUES
...
INSERT INTO SpotifyClone.songs (id, name, artist_id, duration_seg, album_id)
VALUES
  (1, 'Samba em Paris', 4, 267, 6),
  (2, "VIRGO'S GROOVE", 1, 369, 1),
  (3, 'Feeling Good', 6, 100, 8),
  (4, 'O Medo de Amar é o Medo de Ser Livre', 3, 207, 5),
...
INSERT INTO SpotifyClone.user_history (user_id, song_id, playback_date)
VALUES
...
INSERT INTO SpotifyClone.following_artist (user_id, following_artist_id)
VALUES
  (1,1),(1,2),(1,3),(2,1),(2,3),(3,2),(4,4),(5,5),(5,6),(6,1),(6,6),(7,6),(8,NULL),(9,3),(10,2);